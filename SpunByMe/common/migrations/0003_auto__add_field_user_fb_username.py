...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'User.fb_username'
        db.add_column('common_user', 'fb_username', self.gf('django.db.models.fields.CharField')(default='old_username', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'User.fb_username'
        db.delete_column('common_user', 'fb_username')
